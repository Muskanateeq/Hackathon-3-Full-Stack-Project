...
//     const updatedTotal =
//       method === "delivery" ? subtotal + shippingRate : subtotal;
...
//       "orderSummary",
//       JSON.stringify({ subtotal, total, shippingMethod, paymentMethod })
//     );
//     router.push("/shipment-order");
//   };
...
//               <p className="mt-2 text-sm text-gray-400">
//                 Cash payment will be collected upon delivery of your order.
//             </p>
//           )}
//         </div>
//       </div>
...
//                   {!isFormValid &&
//                     "First complete billing details to place the order."}
//                 </p>
...
function HectoDemo() {
  ...
  const handlePlaceOrder = async () => {
    ...
    // Save order ID separately for easy access if needed
    localStorage.setItem("orderId", orderId);

    if (paymentMethod === "bankTransfer") {
      router.push(`/payment?orderId=${orderId}`); // Redirect to payment page
    } else if (paymentMethod === "cashOnDelivery") {
      router.push(`/shipment-order?orderId=${orderId}`); // Redirect to shipment order page
    }
  };
      ...
      <div className="bg-gray-100 py-10">
        <div className="pl-5 sm:pl-5 md:pl-5 lg:pl-28">
          ...
          <Link href="/"><span className="mx-1 text-black">Home</span></Link>
            ...
            <Link href="/shipment-detail"><span className="text-pink-500">Billing Information</span></Link>
        </div>
      </div>
      <div className="bg-white font-sans min-h-screen pb-32">
        <div className="max-w-6xl mx-auto p-6">
