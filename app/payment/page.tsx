...
//   const handleUserAccountNumberChange = (
...
//     if (isPaymentValid) {
//       alert(
//         `Payment confirmed via ${paymentMethod}! Redirecting to order summary...`
//       );
...
//           </h1>
//           <Link href="/">
//             <span className="mx-1 text-black">Home</span>
//           </Link>
//           <span className="mx-1 text-black">.</span>
//           <Link href="/product">
//             <span className="mx-1 text-black">Products List</span>
//           </Link>
//           <span className="mx-1 text-black">.</span>
//           <Link href="/cart">
//             <span className="mx-1 text-black">Cart</span>
//           </Link>
//           <span className="mx-1 text-black">.</span>
//           <Link href="/shipment-detail">
//             <span className="text-black">Billing Information</span>
//           </Link>
//           <span className="mx-1 text-pink-500">.</span>
//           <Link href="/payment">
//             <span className="text-pink-500">Payment Gateway</span>
//           </Link>
//         </div>
//       </div>
...
const PaymentPage = () => {
  ...
  const handleConfirmOrder = () => {
    if (isPaymentValid) {
      alert(`Payment confirmed via ${paymentMethod}! Redirecting to order summary...`);
      router.push(`/shipment-order?orderId=${orderId}`);
    } else {
      alert("Please transfer the full amount to confirm your order.");
    }
    ...
    <Suspense fallback={<div>Loading...</div>}>
      <div className="bg-gray-100 py-10">
        <div className="pl-5 sm:pl-5 md:pl-5 lg:pl-28">
          ...
          <span className="mx-1 text-pink-500">.</span>
          <Link href="/payment"><span className="text-pink-500">Payment Gateway</span></Link>
        </div>
      </div>
      <div className="bg-white font-sans min-h-screen pb-32">
        <div className="max-w-6xl mx-auto p-6">
